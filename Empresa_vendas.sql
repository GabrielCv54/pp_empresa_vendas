...
INSERT INTO CLIENTES VALUES('61752781007','CLÉBER OLIVEIRA','RUA FAGUNDES 1111',985555551,'CLEB.52@GMAIL.COM',NULL)
INSERT INTO VENDAS VALUES(700,10791631079,150,'CARTÃO(DÉBITO)');
...
SELECT * FROM CLIENTES WHERE CPF = '08614342004'
SELECT * FROM VENDAS
...
SELECT FUNC.NOME_FUNC,FUNC.CARGO,STO.NOME_SETOR
FROM FUNCIONARIOS AS FUNC
INNER JOIN SETOR AS STO ON FUNC.SETOR = STO.ID_SETOR

SELECT VND.ID_VENDA,VND.CLIENTE_COMPRADOR,PRD.NOME_PRODUTO,PRD.DESCRIÇÃO
FROM VENDAS AS VND
RIGHT JOIN PRODUTO AS PRD ON PRD.ID_PRODUTO = VND.PRODUTO_VENDIDO

SELECT CLI.CPF,CLI.EMAIL,CLI.NOME_CLIENTE, VND.PRODUTO_VENDIDO
FROM CLIENTES AS CLI
FULL JOIN VENDAS AS VND ON VND.CLIENTE_COMPRADOR = CLI.CPF
ORDER BY CLI.NOME_CLIENTE
