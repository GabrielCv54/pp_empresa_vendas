...
INSERT INTO VENDAS VALUES(421,'81399237020',100,'CARTÃO(DÉBITO)');
...
INSERT INTO AQUISIÇÃO VALUES(3,'GELADEIRA,IMPRESSORA',5,26,72800.00,'2025-06-02');
...
SELECT 
	...
	VND.PRODUTO_VENDIDO,
	CASE
		WHEN LEN(VND.CLIENTE_COMPRADOR) > 0 AND LEN(VND.CLIENTE_COMPRADOR) <= 1 THEN 'CLIENTE POUCO ATIVO'
		WHEN LEN(VND.CLIENTE_COMPRADOR) > 1 AND LEN(VND.CLIENTE_COMPRADOR) <=5 THEN 'CLIENTE MÉDIO ATIVO'
	END AS CLIENTE_MAIS_ATIVO
FROM VENDAS VND
